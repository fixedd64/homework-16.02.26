...
// let res = users.sort((b, a) => a[0] - b[0]);
// let res = users.sort((a, b) => b[0] - a[0]);
// let res = users.sort((item1, item2) => item2[0] - item1[0]);
...
// let res = users.sort((b, a) => a[2] - b[2]);
// let res = users.sort((a, b) => b[2] - a[2]);
...
// let res = users.sort((b, a) => a[3] - b[3]);
// let res = users.sort((a, b) => a[3] - b[3] ? 0 : a[3] - b[3] ? 1 : -1);
// console.log(res);
// debugger;
...
// let res = users.sort((a, b) => a[3] - b[3]);
// let res = users.sort((a, b) => a[3] - b[3] ? -1 : a[3] - b[3] ? 1 : 0);
// console.log(res);
// debugger;
...
// let res = users.sort((a, b) => a[4][0].localeCompare(b[4][0]))
// let res = users.sort((a, b) => a[4][0].toLowerCase().localeCompare(b[4][0].toLowerCase()))
...
// let res = users.sort((a, b) => b[4][0].localeCompare(a[4][0]))
// let res = users.sort((a, b) => b[4][0].toLowerCase().localeCompare(a[4][0].toLowerCase()))
// console.log(res);
// debugger;
